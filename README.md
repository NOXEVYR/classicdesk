...
源码与本地 **0.11.1-dev** 已加入[本地方案库](docs/PROFILE_LIBRARY.md)和[按需启用功能](docs/FEATURE_SELECTION.md)：方案可命名保存、更新、复制、重命名和归档；任务栏布局、尺寸、资源管理器和右键菜单可分别选择应用。新增功能尚未发布到下面的 0.10.0-preview 下载包；公开下载继续保留原版本。
